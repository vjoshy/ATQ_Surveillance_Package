...
#'
#' A data frame simulated from code the subpop_children(elementary)
...
#' @format A data frame with 491 rows and 12 variables
NULL

#' Simulated households with no children data
#'
#' A data frame simulated from code the subpop_noChildren(house_children, elementary)
...
#' @format A data frame with 656 rows and 8 variables
NULL
...
#' @format A data frame with 2,913 rows and 13 variables
NULL
